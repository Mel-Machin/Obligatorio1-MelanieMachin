...
CREATE TABLE `cama` (
  ...
  PRIMARY KEY (`codCama`),
  KEY `cama_ibfk_1` (`idHabitacion`),
  CONSTRAINT `cama_ibfk_1` FOREIGN KEY (`idHabitacion`) REFERENCES `habitacion` (`idHabitacion`) ON DELETE CASCADE,
...
INSERT INTO `cama` VALUES (1,'King',1),(2,'Queen',2),(3,'Individual',3),(4,'Doble',4),(5,'Twin',5),(6,'Individual',NULL),(7,'Doble',NULL),(8,'Queen',NULL),(9,'King',NULL),(10,'Sofa cama',NULL),(13,'Matrimonial',11),(14,'Redonda',12);
...
CREATE TABLE `caracteristica` (
  ...
  KEY `caracteristica_ibfk_1` (`idHabitacion`),
  CONSTRAINT `caracteristica_ibfk_1` FOREIGN KEY (`idHabitacion`) REFERENCES `habitacion` (`idHabitacion`) ON DELETE CASCADE,
...
INSERT INTO `caracteristica` VALUES (1,'WiFi','Servicios',1),(2,'Aire Acondicionado','Servicios',1),(3,'Cama King','Servicios',2),(4,'Desayuno Incluido','Servicios',3),(5,'Estacionamiento','Servicios',1),(6,'Vista al mar','Extra',NULL),(7,'Televisión','Comodidad',NULL),(8,'Wi-Fi','Conectividad',NULL),(9,'Aire acondicionado','Clima',NULL),(10,'Minibar','Comodidad',NULL),(11,'Mini bar','Servicios de cortesía',12),(13,'Balcon ','Vista',15);
...
INSERT INTO `habitacion` VALUES (1,101,1,1),(2,102,1,2),(3,201,2,1),(4,104,1,1),(5,301,3,2),(6,401,3,4),(9,103,4,2),(11,506,2,3),(12,421,3,5),(13,103,1,2),(15,504,7,1);
...
CREATE TABLE `habitacionreserva` (
  ...
  KEY `habitacionreserva_ibfk_2` (`idReserva`),
  CONSTRAINT `habitacionreserva_ibfk_1` FOREIGN KEY (`idHabitacion`) REFERENCES `habitacion` (`idHabitacion`),
  CONSTRAINT `habitacionreserva_ibfk_2` FOREIGN KEY (`idReserva`) REFERENCES `reserva` (`idReserva`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `habitacionreserva` VALUES (2,10),(1,11),(3,12),(4,13),(11,14),(2,15),(9,17),(11,18),(2,20),(11,21),(3,22);
...
INSERT INTO `hotel` VALUES (1,'Hotel Buenos Aires','1000',4),(2,'Hotel Santiago','8320000',5),(3,'Hotel Río','2000',3),(4,'Hotel Bogotá','110111',4),(7,'General City','70000',4);
...
INSERT INTO `huesped` VALUES (1,1,'Juan','Pérez','Gómez','123456789'),(2,3,'María','Rodríguez','López','987654321'),(3,5,'Carlos','García','Martínez','234567890'),(4,4,'Ana','Sánchez','Fernández','345678901'),(7,4,'Alejandra ','Pedrino','Maldran','092563123');
...
CREATE TABLE `reserva` (
  ...
  KEY `fk_huesped` (`idHuesped`),
  CONSTRAINT `fk_huesped` FOREIGN KEY (`idHuesped`) REFERENCES `huesped` (`idHuesped`) ON DELETE CASCADE,
  ...
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`idHuesped`) REFERENCES `huesped` (`idHuesped`) ON DELETE CASCADE,
...
INSERT INTO `reserva` VALUES (7,2,1,NULL,'pendiente','0009-05-16','0016-06-15','pendiente','0021-06-15','pendiente',2,'s'),(10,3,1,NULL,'pendiente','2024-11-03','2024-12-06','pendiente','2024-12-10','pendiente',2,'t'),(11,2,1,NULL,'pendiente','2024-12-05','2024-12-06','pendiente','2024-12-10','pendiente',2,'g'),(12,2,2,NULL,'realizado','2024-12-05','2024-12-06','pendiente','2024-12-10','pendiente',2,'a'),(13,2,2,NULL,'pendiente','2024-12-05','2024-12-06','pendiente','2024-12-12','pendiente',2,'d'),(14,2,2,NULL,'pendiente','2024-12-05','2024-12-06','pendiente','2024-12-10','pendiente',3,'d'),(15,2,1,NULL,'pendiente','2024-11-01','2024-12-01','pendiente','2024-12-04','pendiente',2,'f'),(17,4,4,NULL,'pendiente','2024-01-01','2024-01-01','pendiente','2024-12-30','pendiente',2,'m'),(18,2,2,NULL,'pendiente','2024-01-01','2024-01-01','pendiente','2024-01-01','pendiente',2,''),(20,4,1,NULL,'realizado','2024-01-01','2024-01-01','pendiente','2024-01-01','pendiente',2,''),(21,3,2,NULL,'realizado','2024-01-01','2024-01-01','pendiente','2024-01-01','pendiente',2,''),(22,7,2,NULL,'pendiente','2024-11-12','2024-01-01','pendiente','2024-12-30','pendiente',3,'Es posible realizar el check-in 11:00am');
...
INSERT INTO `tarifa` VALUES (1,'2024-01-01',100.00,1,1),(4,'2024-01-01',300.00,4,1),(5,'2024-01-01',200.00,5,0),(6,'2024-11-04',350.00,3,0),(8,'2024-11-15',400.00,3,1);
...
-- Dump completed on 2024-11-12 23:16:27
